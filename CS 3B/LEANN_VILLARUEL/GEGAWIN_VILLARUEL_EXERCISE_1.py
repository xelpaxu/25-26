...
# Problem No. 1: Student (Pass/Fail) Prediction
# 1.Determine whether the student passes (1) or fails (0) based on: a.Hours studied b.Hours of sleep c.Hours of free time
...
print("<<< Problem No. 1: Student Pass/Fail >>>")
print("Input (8,7) -> Output (Student Pass=1/Student Fail=0):", perceptron_pass_fail(8, 7))
print("Input (3,4) -> Output (Student Pass=1/Student Fail=0):", perceptron_pass_fail(3, 4))



# Problem No. 2: Logic Gate Simulation (+ AND gate verification)
...
print("\n<<< Problem No. 2: AND Gate Simulation >>>")
...
# Problem No. 3: Perceptron Comparison (One vs All)
